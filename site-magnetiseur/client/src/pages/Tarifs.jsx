...
import { FaChildren, FaDog } from "react-icons/fa6";
  ...
  return (
    <section className="tarifs_container">
      ...
      <div className="tarifs_articles">
        ...
        <article className="tarifs_article">
          <FaDog className="tarifs_icon" />
          <h2 className="tarifs_articleTitle">
            Séance pour les animaux <br /> Chien / Chat
          </h2>
          <p className="tarifs_articleText">Soin à distance 50&#8364;</p>
        </article>
      </div>
    </section>
  );
